...
function Work() {
  return (
    <div className="font-readex" id="work">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pt-5">
              <div className="border-2 border-slate-200 rounded-md p-5 cursor-pointer hover:scale-105 duration-200">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3 text-xl">
                    <a
                      href="https://github.com/Akhil-dotcom/vsds-website"
                      className="scale:105 active:95 duration-200"
                    >
                      <FiGithub />
                    </a>
                    <a
                      href="https://vishnu-msds.web.app/"
                      className="scale:105 active:95 duration-200"
                    >
                      <GrShare />
                    </a>
                ...
                <div className="pt-10">
                  ...
                  <p className="pt-3 pb-5">
                    A single page web application created for marketing there
                    schools and allow users to book through there website.
                  </p>
              ...
              <div className="border-2 border-slate-200 rounded-md p-5 cursor-pointer hover:scale-105 duration-200">
                ...
                <div className="pt-10">
                  <div className="font-semibold text-lg md:text-xl">
                    Sreedhar memorial hospital
                  </div>
                  <p className="pt-3 pb-5">
                    Developed a website to market there diabetic treatment
                    center using React Js and Firebase.
                  </p>
                  <div className="flex items-center gap-3 text-green-600">
                    <p>React Js</p>
                    <p>Firebase</p>
              ...
              <div className="border-2 border-slate-200 rounded-md p-5 cursor-pointer hover:scale-105 duration-200">
                ...
                <div className="pt-10">
                  ...
                  <p className="pt-3 pb-5">
                    My portfolio website build using React Js and Scss for
                    styling.
                  </p>
                  <div className="flex items-center gap-3 text-green-600">
                    <p>React Js</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pt-5">
              <div className="border-2 border-slate-200 rounded-md p-5 cursor-pointer hover:scale-105 duration-200">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3 text-xl">
                    <a
                      href="https://github.com/Akhil-dotcom/"
                      className="scale:105 active:95 duration-200"
                    >
                      <FiGithub />
                    </a>
                ...
                <div className="pt-10">
                  <div className="font-semibold text-lg md:text-xl">
                    BlueChip encore private limited.
                  </div>
                  <p className="pt-3 pb-5">
                    Worked as a Full Stack developer developing there products
              ...
              <div className="border-2 border-slate-200 rounded-md p-5 cursor-pointer hover:scale-105 duration-200">
                ...
                <div className="pt-10">
                  <div className="font-semibold text-lg md:text-xl">Enoch.</div>
                  <p className="pt-3 pb-5">
                    Worked as a front end developer, developing a social media
                    application.
                  </p>
                  <div className="flex items-center gap-3 text-green-600">
                    <p>Next Js</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-5">
              <div className="border-2 border-slate-200 rounded-md p-2 bg-slate-200">
                <img
                  ...
                  className="h-56 md:h-72 rounded-md w-full object-contain"
                />
              </div>
              <div className="border-2 border-slate-200 rounded-md p-2 bg-slate-200">
                <img
