...
function TeckStack() {
  return <div className="border p-3 w-full font-readex bg-white shadow-lg rounded-md absolute -top-5 md:top-10 left-5 md:left-10 flex flex-col gap-4 z-30 hover:z-50">
